...
<body>
	...
	<script type="text/javascript">
		...
		function page(index) {
			...
			$.post("<%=path%>/manager/shortvideo_list",{'page':index,'count':pageSize,'status':1,'user_id':user_id,'nick_name':nick_name},function(result){
      ...
      function reviewTableTr(pageData,tr) {
			 ...
			 //操作单元格
			  ...
			  //操作单元格
			  toAdd+="<a class='button border-red' href='javascript:void(0)'	onclick='return changeVideoStatus("+id+",3)'><span class='icon-edit'></span>推荐</a>";
