...
<div class="error-container"> 
    ...
    <div class="errorcon">     
        <i class="icon-smile-o"></i>æä½æå        
        <span style="display:none;"><i class="icon-frown-o"></i>æä½å¤±è´¥!</span>
  
   </div>
    <h4 class="smaller">é¡µé¢èªå¨ <a id="href" href="<?php echo($jumpUrl); ?>">è·³è½¬</a> ç­å¾æ¶é´ï¼ <b id="wait"><?php echo($waitSecond); ?></b></h4> 
