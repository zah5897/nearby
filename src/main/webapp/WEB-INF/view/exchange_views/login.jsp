...
<body>
	...
	<div class="odform">
		<form action="<%=path%>/exchange/do_login" method="post">

			<div class="input-group">
				<label for="khname">漂流瓶账号：</label> 
				<input type="text" id="khname" name="mobile"
					placeholder="漂流瓶账号">
			</div>
			<div class="input-group">
				<label for="khname">漂流瓶密码：</label> 
				<input type="text" id="khname" name="password"
					placeholder="漂流瓶密码">
			</div>
			<button>登录</button>
		</form>
