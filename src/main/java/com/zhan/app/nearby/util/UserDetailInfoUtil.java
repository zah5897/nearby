...
public class UserDetailInfoUtil {
	// public static ModelMap getDetailInfo(UserInfoService userInfoService,
	// Long user_id, int count) {
	...
	// secret_me.put("interest", user.getInterest() != null ? user.getInterest()
	// : new ArrayList<Tag>());
