...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="<%=path %>/manager/selected_dynamic_list?pageIndex=1" target="right"><span class="icon-caret-right"></span>首页推荐</a></li>
    <li><a href="<%=path %>/manager/unselected_dynamic_list?pageIndex=1" target="right"><span class="icon-caret-right"></span>用户动态</a></li>
    <!--  
