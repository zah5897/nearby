...
public class VideoController {
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "user_id", value = "用户id", required = true, paramType = "query"),
			...
			@ApiImplicitParam(name = "type", value = "0为短视频,3为头像认证短视频,默认为0", paramType = "query", dataType = "Integer"),
	...
	public ModelMap send(HttpServletRequest request, long user_id, String token, String aid, String title,
			String video_name, String thumb_img_name, float duration, Integer type, Integer secret_level, String _ua,
			String lat, String lng, String addr, String ios_addr) {
...
//		
//		
//		userDynamicService.loadVideoDynamic(user_id,last_id,count,secret_level);
//		
