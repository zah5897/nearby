...
import com.zhan.app.nearby.service.TelVideoService;
...
public class TelVideoController {

	@Resource
	private TelVideoService telVideoService;
	...
	public Map<String, Object> live(long user_id, String token, String aid, String client_uuid, int time) {
		...
		return telVideoService.live(token, aid, video);
	}
